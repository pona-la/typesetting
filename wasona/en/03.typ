...
The English translation includes words and word-pieces like "the", "an", "-s", but those are guesses! The Toki Pona sentence doesn't specify if we're talking about "#emph[a] bird" or "#emph[the] bird". In longer conversations, it becomes pretty clear!
