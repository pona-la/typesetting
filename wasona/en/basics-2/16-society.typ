...
Here is something fun you might notice: #strong[󱤋 esun] generally means 'to
swap', but there's enough information in the sentences to know that it
specifically means 'to sell' in one sentence, and 'to buy' in another!

== more about mute

#strong[󱤼 mute] is a very useful word to have. We don't see adjectives attach to
pronouns #strong[󱤴 mi], #strong[󱥞 sina], #strong[󱥆 ona] all that often, but
...
Remember the special rule that says: "when #strong[󱤴 mi] or #strong[󱥞 sina] is
the subject of the sentence, we remove the #strong[󱤧 li]"? That rule is quite
...
either #strong[󱤴 mi] or #strong[󱥞 sina], but instead #strong[󱤴󱤼 mi mute] and
#strong[󱥞󱤼 sina mute]!
