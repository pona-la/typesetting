...
I initially put this out in an afternoon as I was excited to read it! I'd like to spend a bit more time on it to tidy things up, with the goal of getting it as close to the original edition as possible.

That means restoring all the original illustrations (and replacing their english text with toki pona), and redoing a lot of the interior and exterior layout. This may take a while!
...
- Image > Canvas Size. Resize the canvas to our target: 8.27\*600 by 5.83\*600. (Based on A5 at 600dpi)
- Layers > Layer to Image Size. Fit layer to canvas, to add a white border.
...
(Note: the hex codes aren't complete, I'm just sketching out which inks are needed.)
...
I dedicate `main.typ` to the public domain using CC0.

The fonts in this repo are under free, permissive licenses, but are not public domain. For that reason, I do not dedicate `header.png` and `osawi.pdf` to the public domain, as I'm not sure whether I am able to! (Please inform me if I can!)
